    ...
    <div class="bg-white rounded-2xl border border-neutral-200 shadow-sm overflow-hidden">
        <div class="bg-gradient-to-r from-blue-700 to-blue-900 px-6 py-5">
            <div class="flex items-center gap-3 text-white">
                ...
                <div>
                    <h3 class="font-bold">Edit Vendor</h3>
                    <p class="text-xs text-blue-100 opacity-80">Perbarui informasi mitra {{ $vendor->nama_vendor }}</p>
                </div>
            </div>
        </div>

        <form action="{{ route('vendors.update', $vendor->id) }}" method="POST" class="p-8 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="kontak" id="kontak" 
                           ...
                           value="{{ old('kontak', $vendor->kontak) }}" placeholder="Contoh: 08123456789">
                </div>
            ...
            <div class="space-y-2">
                ...
                <textarea name="keterangan" id="keterangan" rows="4" 
                          ...
                          placeholder="Tambahkan catatan singkat (opsional)">{{ old('keterangan', $vendor->keterangan) }}</textarea>
